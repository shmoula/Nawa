...
/**
 * https://github.com/3squared/ActiveAndroid-Loaders
 */
...
public class ModelLoader<T extends Model> extends AsyncTaskLoader<List<T>> {
     ...
     *
     * @param context the model subclass you wish to query
     ...
     * @param clazz                       the model subclass you wish to query
     * @param updateOnRelationshipChanges if true, loader will updated when tables related to the one detected are changed
     */
     ...
     * @param context                     the context
     * @param clazz                       the model subclass you wish to query
     * @param from                        a select/from statement that will be executed to retrieve the objects
     * @param updateOnRelationshipChanges if true, loader will updated when tables related to the one detected are changed
     */
     ...
     * little more logic.
     *
     * @param models the new models to be delivered
     */
    @Override
